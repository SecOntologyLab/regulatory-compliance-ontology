...
[![DOI](https://zenodo.org/badge/DOI/10.5281/zenodo.18763491.svg)](https://doi.org/10.5281/zenodo.18763491)
...
**Sabaliauskaitė, G., Paskauskas, R. A., Bružė, E., Matulytė, R., & Lavišius, T.** (2026). Automated Regulatory Compliance for AI Systems in the Security Domain: The Case of Dual-Use Deployment. *Open Research Europe* (forthcoming).
